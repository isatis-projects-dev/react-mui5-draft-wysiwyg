...
var GlobalStyles = _interopDefault(require('@mui/material/GlobalStyles'));
...
function ButtonControl(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement(IconButton, _extends({
    onClick: onClick,
    disabled: disabled,
    color: active ? 'primary' : 'default'
  }, rest), /*#__PURE__*/React__default.createElement(Badge, {
    anchorOrigin: {
      vertical: 'top',
      horizontal: 'left'
    },
...
function UndoControl() {
  ...
  return /*#__PURE__*/React__default.createElement(ButtonControl, {
    onClick: onClick,
    text: editor.translate('controls.undo.title')
  }, /*#__PURE__*/React__default.createElement(UndoIcon, null));
}
...
function RedoControl() {
  ...
  }, /*#__PURE__*/React__default.createElement(RedoIcon, null));
}
...
function BoldControl() {
  var editor = useEditor();
  return /*#__PURE__*/React__default.createElement(ToggleInlineStyleButtonControl, {
...
function LinkAddControl() {
  ...
  var formRef = React__default.createRef();
  var onClick = function onClick() {
    setLink('');
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(ButtonControl, {
    onClick: onClick,
  ...
  }, /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement(TextField, {
    autoFocus: true,
    ...
    color: "primary"
  }, editor.translate('controls.linkAdd.actions.cancel')), /*#__PURE__*/React__default.createElement(Button, {
    type: "submit",
    color: "primary",
    disabled: link === ''
...
var EditorLink = function EditorLink(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Link, {
    ...
    onClick: openLink,
    title: "Open " + url
  }, /*#__PURE__*/React__default.createElement(LaunchIcon, null)), /*#__PURE__*/React__default.createElement(Button, {
    onClick: removeLink,
    title: "Remove link"
  }, /*#__PURE__*/React__default.createElement(LinkOffIcon, null)))));
};
...
function DropdownControl(_ref) {
  ...
  var classes = useStyles$1(material.useTheme());
  var editor = useEditor();
...
function BlockTypeControl(_ref) {
  ...
  var _React$useState = React__default.useState('default'),
  ...
  return /*#__PURE__*/React__default.createElement(DropdownControl, {
    options: options,
...
function UnorderedListControl() {
  var editor = useEditor();
  return /*#__PURE__*/React__default.createElement(ToggleBlockTypeButtonControl, {
...
function FontFamilyControl(_ref) {
  ...
  var editor = useEditor();
  var editorFocus = useEditorFocus();
  var _React$useState = React__default.useState(inlineStyles.FONT_FAMILY + "-default"),
  ...
  return /*#__PURE__*/React__default.createElement(DropdownControl, {
    options: styleKeys.map(function (inlineStyle) {
      return {
        value: inlineStyle,
        text: pluginData.customStyleMap[inlineStyle].fontFamily ? /*#__PURE__*/React__default.createElement("span", {
          style: {
...
function TextAlignControl() {
  ...
  }, /*#__PURE__*/React__default.createElement(FormatAlignLeftIcon, null)), /*#__PURE__*/React__default.createElement(ButtonControl, {
    active: selectedTextAlign === 'center',
    onClick: function onClick() {
      return toggle('center');
    },
    text: editor.translate('controls.textAlign.actions.alignCenter')
  }, /*#__PURE__*/React__default.createElement(FormatAlignCenterIcon, null)), /*#__PURE__*/React__default.createElement(ButtonControl, {
    active: selectedTextAlign === 'right',
    onClick: function onClick() {
      return toggle('right');
    },
    text: editor.translate('controls.textAlign.actions.alignRight')
  }, /*#__PURE__*/React__default.createElement(FormatAlignRightIcon, null)), /*#__PURE__*/React__default.createElement(ButtonControl, {
...
function FontSizeControl(_ref) {
  ...
  var editor = useEditor();
  var editorFocus = useEditorFocus();
  var _React$useState = React__default.useState(inlineStyles.FONT_SIZE + "-default"),
  ...
  return /*#__PURE__*/React__default.createElement(DropdownControl, {
    options: styleKeys.map(function (inlineStyle) {
      return {
        text: pluginData.customStyleMap[inlineStyle].fontSize ? /*#__PURE__*/React__default.createElement("span", {
          style: {
...
var useStyles$2 = function useStyles() {
  return {
    colorRow: {
      display: 'flex',
      alignContent: 'center',
...
function ColorSelectorControl(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(ButtonControl, _extends({
    onClick: handleOpen,
    "aria-controls": menuId,
    "aria-haspopup": "true",
    badgeColor: selectedColor ? selectedColor.color : null
  }, rest), children), /*#__PURE__*/React__default.createElement(Popover, {
    id: menuId,
    anchorEl: anchorEl,
    anchorOrigin: {
      vertical: 'bottom',
    ...
    startIcon: /*#__PURE__*/React__default.createElement(FormatColorResetIcon, null),
    fullWidth: true,
    color: "secondary",
    onClick: function onClick() {
      handleClose();
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, selectedColor && colorData.value === selectedColor.value ? /*#__PURE__*/React__default.createElement(CheckIcon, {
        style: {
...
function ToggleInlineStyleColorSelectorControl(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(ColorSelectorControl, {
    text: text,
...
function FontColorControl(_ref) {
  var configuration = _ref.configuration,
    ...
    pluginData = _ref.pluginData;
  var editor = useEditor();
  return /*#__PURE__*/React__default.createElement(ToggleInlineStyleColorSelectorControl, {
...
function FontBackgroundColorControl(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement(BorderColorIcon, null));
}
...
function ImageToUpload(_ref) {
  var width = _ref.width,
    height = _ref.height,
    src = _ref.src;
  var classes = useStyles$3(material.useTheme());
  return /*#__PURE__*/React__default.createElement("div", {
...
function SizeInputs(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Grid, {
    ...
    size: "small"
  }, maintainAspectRatio ? /*#__PURE__*/React__default.createElement(LockIcon, null) : /*#__PURE__*/React__default.createElement(LockOpenIcon, null))), /*#__PURE__*/React__default.createElement(Grid, {
    item: true
  }, /*#__PURE__*/React__default.createElement(TextField, {
    type: "number",
...
function ByUrlDialog(_ref) {
  ...
  var content = null;
  if (isUploading) content = /*#__PURE__*/React__default.createElement(CircularProgress, null);else if (isValidImage && imageURL) content = /*#__PURE__*/React__default.createElement(ImageToUpload, {
    src: imageURL,
    height: imageHeight,
    width: imageWidth
  });else if (hasError && !isValidImage && imageURL) content = /*#__PURE__*/React__default.createElement(Typography, {
    variant: "subtitle1",
    color: "error",
    gutterBottom: true
  ...
  return /*#__PURE__*/React__default.createElement(Dialog, {
    ...
    onSubmit: handleSubmit
  }, /*#__PURE__*/React__default.createElement(DialogContent, null, isValidImage && imageURL !== '' && /*#__PURE__*/React__default.createElement(SizeInputs, {
    width: imageWidth,
    ...
    alignItems: "center",
    justify: "center"
  }, content), /*#__PURE__*/React__default.createElement(TextField, {
    autoFocus: true,
    ...
    onClick: onClose,
    color: "primary"
  }, editor.translate('controls.image.actions.cancel')), /*#__PURE__*/React__default.createElement(Button, {
    type: "submit",
    color: "primary",
...
var useStyles$4 = function useStyles(theme, highlightDropArea) {
  return {
    dropArea: {
      width: 500,
      height: 300,
...
function UploadDialog(_ref) {
  ...
  var inputFileRef = React__default.createRef();
  var classes = useStyles$4(material.useTheme(), highlightDropArea);
  var handleSubmit = function handleSubmit(ev) {
    ev.preventDefault();
    ev.stopPropagation();
    onSubmit({
  ...
  var onSelectFile = function onSelectFile(file) {
    try {
      setHighlightDropArea(false);
      setIsUploading(true);
      var _temp3 = helpers._catch(function () {
  ...
  var dropAreaContent = /*#__PURE__*/React__default.createElement(Typography, {
    variant: "subtitle1"
  }, editor.translate('controls.image.labels.dropImageHere'));
  if (isUploading) {
    dropAreaContent = /*#__PURE__*/React__default.createElement(CircularProgress, null);
  } else if (isValidImage && imageURL) {
    dropAreaContent = /*#__PURE__*/React__default.createElement(ImageToUpload, {
      src: imageURL,
      height: imageHeight,
      width: imageWidth
    });
  ...
  return /*#__PURE__*/React__default.createElement(Dialog, {
    ...
    onSubmit: handleSubmit
  }, /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement("input", {
    ref: inputFileRef,
    type: "file",
    accept: "image/*",
  ...
  }), isValidImage && imageURL !== '' && /*#__PURE__*/React__default.createElement(SizeInputs, {
    originalWidth: imageOriginalWidth,
    originalHeight: imageOriginalHeight,
    width: imageWidth,
    height: imageHeight,
    onChangeWidth: setImageWidth,
    onChangeHeight: setImageHeight
  }), hasError && !isValidImage && /*#__PURE__*/React__default.createElement(Typography, {
    variant: "subtitle1",
    color: "error",
    align: "center",
    gutterBottom: true
  }, errorMessage !== null ? errorMessage : editor.translate('controls.image.errorMessages.notValidImage')), /*#__PURE__*/React__default.createElement("div", {
    ...
    onDrop: handleDrop
  }, dropAreaContent)), /*#__PURE__*/React__default.createElement(DialogActions, null, /*#__PURE__*/React__default.createElement(Button, {
    type: "button",
    onClick: onClose,
    color: "primary"
  }, editor.translate('controls.image.actions.cancel')), /*#__PURE__*/React__default.createElement(Button, {
...
function ResizeImageDialog(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Dialog, {
    ...
    onSubmit: handleSubmit
  }, /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement(SizeInputs, {
    width: width,
    height: height,
    ...
    alignItems: "center",
    justify: "center"
  }, /*#__PURE__*/React__default.createElement(ImageToUpload, {
    src: src,
    width: width,
    height: height
  }))), /*#__PURE__*/React__default.createElement(DialogActions, null, /*#__PURE__*/React__default.createElement(Button, {
...
function ImageControl(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(ButtonControl, {
    ...
    "aria-controls": menuId,
    "aria-haspopup": "true"
  }, /*#__PURE__*/React__default.createElement(ImageIcon, null)), /*#__PURE__*/React__default.createElement(Popover, {
    id: menuId,
    anchorEl: anchorEl,
    anchorOrigin: {
      vertical: 'bottom',
  ...
  }, /*#__PURE__*/React__default.createElement(ListItemIcon, null, /*#__PURE__*/React__default.createElement(PublishIcon, null)), /*#__PURE__*/React__default.createElement(ListItemText, {
  ...
  }, /*#__PURE__*/React__default.createElement(ListItemIcon, null, /*#__PURE__*/React__default.createElement(LinkIcon, null)), /*#__PURE__*/React__default.createElement(ListItemText, {
    primary: editor.translate('controls.image.actions.url')
  })))), /*#__PURE__*/React__default.createElement(ByUrlDialog, {
    onSubmit: handleSubmitImage,
    onClose: function onClose() {
      return setIsUrlDialogOpened(false);
    },
    open: isUrlDialogOpened
  }), /*#__PURE__*/React__default.createElement(UploadDialog, {
    onSubmit: handleSubmitImage,
    onClose: function onClose() {
  ...
  }), /*#__PURE__*/React__default.createElement(ResizeImageDialog, {
...
var EditorMedia = function EditorMedia(_ref) {
  ...
  if (type === entities.IMAGE) {
    ...
    return /*#__PURE__*/React__default.createElement(EditorImage, {
      src: src,
      width: width,
      height: height,
      block: block,
...
var useStyles$5 = function useStyles(theme) {
  return {
    imgInfo: {
...
var EditorImage = function EditorImage(_ref2) {
  ...
  var editor = useEditor();
  var editorFocus = useEditorFocus();
  var classes = useStyles$5(material.useTheme());
  var showOptions = function showOptions(ev) {
    setAnchorEl(ev.currentTarget);
  ...
  }, width, "\xA0x\xA0", height)), /*#__PURE__*/React__default.createElement(Popover, {
    open: Boolean(anchorEl),
    onClose: hideOptions,
    anchorEl: anchorEl,
    anchorOrigin: {
  ...
  }, /*#__PURE__*/React__default.createElement(ArrowLeftIcon, null), /*#__PURE__*/React__default.createElement(ImageIcon, null)), /*#__PURE__*/React__default.createElement(Button, {
    onClick: function onClick(ev) {
      return imageAlign(ev, 'center');
    },
    title: editor.translate('controls.image.actions.alignCenter')
  }, /*#__PURE__*/React__default.createElement(ArrowLeftIcon, null), /*#__PURE__*/React__default.createElement(ImageIcon, null), /*#__PURE__*/React__default.createElement(ArrowRightIcon, null)), /*#__PURE__*/React__default.createElement(Button, {
    onClick: function onClick(ev) {
      return imageAlign(ev, 'right');
    },
    title: editor.translate('controls.image.actions.alignRight')
  }, /*#__PURE__*/React__default.createElement(ImageIcon, null), /*#__PURE__*/React__default.createElement(ArrowRightIcon, null)), /*#__PURE__*/React__default.createElement(Button, {
    onClick: function onClick() {
      hideOptions();
      editor.showResizeImageDialog(block.getEntityAt(0));
    },
    title: editor.translate('controls.image.actions.resize')
  }, /*#__PURE__*/React__default.createElement(PhotoSizeSelectLargeIcon, null)), /*#__PURE__*/React__default.createElement(Button, {
    onClick: removeImage,
...
var EditorFactories = /*#__PURE__*/function () {
  ...
  _proto.getToolbarControlComponents = function getToolbarControlComponents() {
    ...
    return this.getToolbarControls().map(function (control) {
      ...
      return React__default.createElement(control.component, {
...
function EditorToolbar(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Paper, _extends({
    hidden: !visible
  }, rest), /*#__PURE__*/React__default.createElement(Grid, {
    container: true,
    alignItems: "center"
  }, children));
}
...
var useStyles$6 = function useStyles(theme) {
  return {
    editorWrapper: {
      marginTop: theme.spacing(2),
      marginBottom: theme.spacing(2),
...
function MUIEditor(_ref) {
  ...
  var editorFactories = new EditorFactories(config);
  var editorRef = React__default.useRef(null);
  var translateRef = React__default.useRef(function () {});
  var translationsRef = React__default.useRef(null);
  var toolbarVisibleConfig = editorFactories.getConfigItem('toolbar', 'visible');
  var _React$useState = React__default.useState(toolbarVisibleConfig),
  ...
  translateRef.current = React__default.useCallback(function (id) {
    var translator = new Translator(translationsRef.current);
    return translator.get(id);
  }, []);
  var classes = useStyles$6(material.useTheme());
  React__default.useEffect(function () {
    setIsToolbarVisible(toolbarVisibleConfig);
  }, [toolbarVisibleConfig]);
  var toolbar = /*#__PURE__*/React__default.createElement(EditorToolbar, {
  ...
  var EditorWrapper = React__default.createElement(editorWrapperElement, editorWrapperProps, /*#__PURE__*/React__default.createElement(draftJs.Editor, _extends({}, editorFactories.getConfigItem('draftEditor'), {
    ref: editorRef,
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(GlobalStyles, {
    styles: {
